...
```go
// Ensures *Type implements Interface at compile time
...
| [Data Handling](references/data-handling.md) | Iterators, streaming, large transfers |
| [Resource Management](references/resource-management.md) | defer, pools, graceful shutdown |
